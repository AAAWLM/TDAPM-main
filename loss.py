...
class DomainAdversarialLoss(nn.Module):
    ...
    Args:
        domain_discriminator (torch.nn.Module): A_os63 domain discriminator object, which predicts the domains of features. Its input shape is (N, F) and output shape is (N, 1)
